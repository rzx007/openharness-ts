...
export const desktopAPI = {
  ...
  window: {
    ...
    setZoomLevel: (level: number) =>
      invoke(IpcChannels.windowSetZoomLevel, level),
    ...
    onMaximizedChanged: (listener: (value: boolean) => void): (() => void) => {
      ...
      return () =>
        ipcRenderer.removeListener(IpcEvents.windowMaximizedChanged, wrapped);
    },
  },
  tray: {
    flash: () => invoke(IpcChannels.trayFlash),
    stopFlash: () => invoke(IpcChannels.trayStopFlash),
    notify: (options: TrayNotificationOptions) =>
      invoke(IpcChannels.trayNotify, options),
  },
  pet: {
    ...
    setAlwaysOnTop: (value: boolean) =>
      invoke(IpcChannels.petSetAlwaysOnTop, value),
  ...
  workspace: {
    listFiles: (
      input: IpcInvokeMap[typeof IpcChannels.workspaceListFiles]["args"][0],
    ) => invoke(IpcChannels.workspaceListFiles, input),
    readFile: (
      input: IpcInvokeMap[typeof IpcChannels.workspaceReadFile]["args"][0],
    ) => invoke(IpcChannels.workspaceReadFile, input),
    revealPath: (
      input: IpcInvokeMap[typeof IpcChannels.workspaceRevealPath]["args"][0],
    ) => invoke(IpcChannels.workspaceRevealPath, input),
    copyPath: (
      input: IpcInvokeMap[typeof IpcChannels.workspaceCopyPath]["args"][0],
    ) => invoke(IpcChannels.workspaceCopyPath, input),
    listOpeners: () => invoke(IpcChannels.workspaceListOpeners),
    openWith: (
      input: IpcInvokeMap[typeof IpcChannels.workspaceOpenWith]["args"][0],
  ...
  git: {
    ...
    fileDiff: (
      input: IpcInvokeMap[typeof IpcChannels.gitFileDiff]["args"][0],
  ...
  attachments: {
    ...
    startUpload: (
      input: IpcInvokeMap[typeof IpcChannels.attachmentStartUpload]["args"][0],
    ) => invoke(IpcChannels.attachmentStartUpload, input),
    cancelUpload: (
      input: IpcInvokeMap[typeof IpcChannels.attachmentCancelUpload]["args"][0],
    ) => invoke(IpcChannels.attachmentCancelUpload, input),
    retryUpload: (
      input: IpcInvokeMap[typeof IpcChannels.attachmentRetryUpload]["args"][0],
    ) => invoke(IpcChannels.attachmentRetryUpload, input),
    discardDraft: (
      input: IpcInvokeMap[typeof IpcChannels.attachmentDiscardDraft]["args"][0],
    ...
    readPreview: (
      input: IpcInvokeMap[typeof IpcChannels.attachmentReadPreview]["args"][0],
    ...
    saveAs: (
      input: IpcInvokeMap[typeof IpcChannels.attachmentSaveAs]["args"][0],
    ...
    onUploadEvent: (
      listener: (event: DesktopAttachmentUploadEvent) => void,
    ): (() => void) => {
      const wrapped = (
        _event: Electron.IpcRendererEvent,
      ...
      return () =>
        ipcRenderer.removeListener(IpcEvents.attachmentUploadEvent, wrapped);
    },
  },
  terminal: {
    create: (
      input: IpcInvokeMap[typeof IpcChannels.terminalCreate]["args"][0],
    ...
    resize: (
      input: IpcInvokeMap[typeof IpcChannels.terminalResize]["args"][0],
  ...
  schedules: {
    ...
    create: (
      input: IpcInvokeMap[typeof IpcChannels.scheduleCreate]["args"][0],
    ) => invoke(IpcChannels.scheduleCreate, input),
    update: (
      id: string,
      input: IpcInvokeMap[typeof IpcChannels.scheduleUpdate]["args"][1],
    ...
    listRuns: (
      input: IpcInvokeMap[typeof IpcChannels.scheduleListRuns]["args"][0],
  ...
  providers: {
    ...
    connect: (
      input: IpcInvokeMap[typeof IpcChannels.providerConnect]["args"][0],
    ) => invoke(IpcChannels.providerConnect, input),
    activate: (
      input: IpcInvokeMap[typeof IpcChannels.providerActivate]["args"][0],
    ) => invoke(IpcChannels.providerActivate, input),
    disconnect: (
      input: IpcInvokeMap[typeof IpcChannels.providerDisconnect]["args"][0],
    ) => invoke(IpcChannels.providerDisconnect, input),
    createCustom: (
      input: IpcInvokeMap[typeof IpcChannels.providerCustomCreate]["args"][0],
    ) => invoke(IpcChannels.providerCustomCreate, input),
    updateCustom: (
      input: IpcInvokeMap[typeof IpcChannels.providerCustomUpdate]["args"][0],
    ) => invoke(IpcChannels.providerCustomUpdate, input),
    removeCustom: (
      input: IpcInvokeMap[typeof IpcChannels.providerCustomRemove]["args"][0],
    ) => invoke(IpcChannels.providerCustomRemove, input),
  },
  settings: {
    snapshot: () => invoke(IpcChannels.settingsSnapshot),
    updateWorkStyle: (
      input: IpcInvokeMap[typeof IpcChannels.settingsUpdateWorkStyle]["args"][0],
  ...
  plugins: {
    snapshot: (
      input: IpcInvokeMap[typeof IpcChannels.pluginSnapshot]["args"][0],
    ...
    disable: (
      input: IpcInvokeMap[typeof IpcChannels.pluginDisable]["args"][0],
    ) => invoke(IpcChannels.pluginDisable, input),
    uninstall: (
      input: IpcInvokeMap[typeof IpcChannels.pluginUninstall]["args"][0],
  ...
  sessions: {
    ...
    inspectProject: (path: string) =>
      invoke(IpcChannels.sessionInspectProject, path),
    listCommands: (cwd: string) => invoke(IpcChannels.sessionListCommands, cwd),
    renameProject: (
      input: IpcInvokeMap[typeof IpcChannels.projectRename]["args"][0],
    ) => invoke(IpcChannels.projectRename, input),
    setProjectPinned: (
      input: IpcInvokeMap[typeof IpcChannels.projectSetPinned]["args"][0],
    ...
    rebindProject: (projectId: string) =>
      invoke(IpcChannels.projectRebind, projectId),
    checkoutBranch: (
      input: IpcInvokeMap[typeof IpcChannels.projectCheckoutBranch]["args"][0],
    ) => invoke(IpcChannels.projectCheckoutBranch, input),
    createBranch: (
      input: IpcInvokeMap[typeof IpcChannels.projectCreateBranch]["args"][0],
    ) => invoke(IpcChannels.projectCreateBranch, input),
    create: (
      input: IpcInvokeMap[typeof IpcChannels.sessionCreate]["args"][0],
    ) => invoke(IpcChannels.sessionCreate, input),
    open: (sessionId: string) => invoke(IpcChannels.sessionOpen, sessionId),
    openAux: (
      input: IpcInvokeMap[typeof IpcChannels.sessionAuxOpen]["args"][0],
    ) => invoke(IpcChannels.sessionAuxOpen, input),
    closeAux: (
      input: IpcInvokeMap[typeof IpcChannels.sessionAuxClose]["args"][0],
    ...
    sendPrompt: (
      input: IpcInvokeMap[typeof IpcChannels.sessionSendPrompt]["args"][0],
    ...
    interrupt: (
      input: IpcInvokeMap[typeof IpcChannels.sessionInterrupt]["args"][0],
    ) => invoke(IpcChannels.sessionInterrupt, input),
    replyPermission: (
      input: IpcInvokeMap[typeof IpcChannels.sessionReplyPermission]["args"][0],
    ) => invoke(IpcChannels.sessionReplyPermission, input),
    setDefaultModel: (
      input: IpcInvokeMap[typeof IpcChannels.sessionSetDefaultModel]["args"][0],
    ...
    updateModel: (
      input: IpcInvokeMap[typeof IpcChannels.sessionUpdateModel]["args"][0],
    ...
    rename: (
      input: IpcInvokeMap[typeof IpcChannels.sessionRename]["args"][0],
    ) => invoke(IpcChannels.sessionRename, input),
    setPinned: (
      input: IpcInvokeMap[typeof IpcChannels.sessionSetPinned]["args"][0],
    ) => invoke(IpcChannels.sessionSetPinned, input),
    archive: (sessionId: string) =>
      invoke(IpcChannels.sessionArchive, sessionId),
    delete: (sessionId: string) => invoke(IpcChannels.sessionDelete, sessionId),
    onDaemonStatusChanged: (
      listener: (value: DesktopDaemonStatus) => void,
    ): (() => void) => {
      const wrapped = (
        _event: Electron.IpcRendererEvent,
        value: DesktopDaemonStatus,
      ): void => listener(value);
      ipcRenderer.on(IpcEvents.sessionDaemonStatusChanged, wrapped);
      return () =>
        ipcRenderer.removeListener(
          IpcEvents.sessionDaemonStatusChanged,
          wrapped,
        );
    },
    onUpdated: (
      ...
      return () =>
        ipcRenderer.removeListener(IpcEvents.sessionUpdated, wrapped);
    },
    onAuxUpdated: (
      ...
      return () =>
        ipcRenderer.removeListener(IpcEvents.sessionAuxUpdated, wrapped);
    },
  },
  context: {
    list: (input: IpcInvokeMap[typeof IpcChannels.contextList]["args"][0]) =>
      invoke(IpcChannels.contextList, input),
    add: (input: IpcInvokeMap[typeof IpcChannels.contextAdd]["args"][0]) =>
      invoke(IpcChannels.contextAdd, input),
    update: (
      input: IpcInvokeMap[typeof IpcChannels.contextUpdate]["args"][0],
    ) => invoke(IpcChannels.contextUpdate, input),
    remove: (
      input: IpcInvokeMap[typeof IpcChannels.contextRemove]["args"][0],
    ) => invoke(IpcChannels.contextRemove, input),
    candidates: (
      input: IpcInvokeMap[typeof IpcChannels.contextCandidates]["args"][0],
    ) => invoke(IpcChannels.contextCandidates, input),
    accept: (
      input: IpcInvokeMap[typeof IpcChannels.contextAccept]["args"][0],
    ) => invoke(IpcChannels.contextAccept, input),
    reject: (
      input: IpcInvokeMap[typeof IpcChannels.contextReject]["args"][0],
    ) => invoke(IpcChannels.contextReject, input),
    preview: (
      input: IpcInvokeMap[typeof IpcChannels.contextPreview]["args"][0],
    ) => invoke(IpcChannels.contextPreview, input),
    status: (
      input: IpcInvokeMap[typeof IpcChannels.contextStatus]["args"][0],
    ) => invoke(IpcChannels.contextStatus, input),
  },
