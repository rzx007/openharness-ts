...
const PnpmIcon = (p: SVGProps<SVGSVGElement>): React.JSX.Element => (
  <svg
...
const NpmIcon = (p: SVGProps<SVGSVGElement>): React.JSX.Element => (
...
const YarnIcon = (p: SVGProps<SVGSVGElement>): React.JSX.Element => (
...
const BunIcon = (p: SVGProps<SVGSVGElement>): React.JSX.Element => (
...
export function MultiFileCodeBlock({
  ...
  bodyClassName,
  className,
}: MultiFileCodeBlockProps): React.JSX.Element {
...
export function LanguageTabsCodeBlock({
  ...
  bodyClassName,
  className,
}: LanguageTabsCodeBlockProps): React.JSX.Element {
...
function buildCommand(pm: string, url: string): string {
  switch (pm) {
    case "npm":
...
export function InstallCommand({ registryUrl, className }: InstallCommandProps): React.JSX.Element {
